...
const ProductCard = ({ product }) => {
    return (
        <Card sx={{ boxShadow: 3, borderRadius: 2, display: "flex", flexDirection: "column", height: "100%", width: "100%" }}>
            ...
            <CardActions sx={{ padding: "16px", justifyContent: "flex-start", marginTop: "auto" }}>
                <Button
                    variant="contained"
